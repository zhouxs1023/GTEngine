...
TemplateV16::TemplateV16(std::string const& name, std::string const& gtPath, bool& success)
    :
    mName(name),
    mGTPath(gtPath),
	...
	mSolutionGUID(GetGuidString())
{
    ...
    std::string filtName = mName + ".v16.vcxproj.filters";
...
bool TemplateV16::Create(std::string const& name, std::vector<std::string> const& lines, bool useUT8)
{
...
std::string TemplateV16::GetGuidString()
{
    UUID guid;
...
std::regex const TemplateV16::mGPPattern("GTPATH");
std::regex const TemplateV16::mPNPattern("PROJECTNAME");
std::regex const TemplateV16::mPGPattern("PROJECTGUID");
std::regex const TemplateV16::mRQPattern("REQUIREDGUID");
std::regex const TemplateV16::mGTPattern("GTGUID");
std::regex const TemplateV16::mSGPattern("SOLUTIONGUID");
std::string const TemplateV16::msGTGUID("43A54DE9-1F9B-4BC6-A7BC-C3FD13B2C829");
...
#endif
std::vector<std::string> const TemplateV16::msSolutionLines =
{
"Microsoft Visual Studio Solution File, Format Version 12.00",
"# Visual Studio Version 16",
"VisualStudioVersion = 16.0.28803.156",
"MinimumVisualStudioVersion = 10.0.40219.1",
"Project(\"{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}\") = \"PROJECTNAME.v16\", \"PROJECTNAME.v16.vcxproj\", \"{PROJECTGUID}\"",
"EndProject",
"Project(\"{2150E333-8FDC-42A3-9474-1A3956D46DE8}\") = \"Required\", \"Required\", \"{REQUIREDGUID}\"",
"EndProject",
"Project(\"{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}\") = \"GTEngine.v16\", \"GTPATHGTEngine.v16.vcxproj\", \"{GTGUID}\"",
"EndProject",
"Global",
...
std::vector<std::string> const TemplateV16::msProjectLines =
{
...
"  </ItemGroup>",
"  <ItemGroup>",
"    <ProjectReference Include=\"GTPATHGTEngine.v16.vcxproj\">",
...
std::vector<std::string> const TemplateV16::msFilterLines =
{
"﻿<?xml version=\"1.0\" encoding=\"utf-8\"?>",
...
std::vector<std::string> const TemplateV16::msWinHLines =
{
"#pragma once",
"",
"#include <GTEngine.h>",
...
std::vector<std::string> const TemplateV16::msWinCLines =
{
