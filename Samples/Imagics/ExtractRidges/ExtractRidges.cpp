...
static void SaveImage(std::string const& name, Image2<double> const& image)
{
...
int main()
{
    ...
    std::string path = environment.GetVariable("GTE_PATH");
    if (path == "")
    {
    ...
    environment.Insert(path + "/Samples/Data/");
    path = environment.GetPath("Head_U16_X256_Y256.binary");
    if (path == "")
    {
