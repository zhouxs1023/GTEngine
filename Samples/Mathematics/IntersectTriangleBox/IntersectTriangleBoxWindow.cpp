...
void IntersectTriangleBoxWindow::Translate(int direction, float delta)
{
...
void IntersectTriangleBoxWindow::Rotate(int direction, float delta)
{
...
void IntersectTriangleBoxWindow::DoIntersectionQuery()
{
