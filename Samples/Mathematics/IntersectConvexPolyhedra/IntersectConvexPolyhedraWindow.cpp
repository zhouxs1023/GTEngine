...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"IntersectConvexPolyhedraWindow", 0, 0, 768, 768);
    auto window = TheWindowSystem.Create<IntersectConvexPolyhedraWindow>(parameters);
    TheWindowSystem.MessagePump(window, TheWindowSystem.DEFAULT_ACTION);
    TheWindowSystem.Destroy<IntersectConvexPolyhedraWindow>(window);
    return 0;
}

IntersectConvexPolyhedraWindow::IntersectConvexPolyhedraWindow(Parameters& parameters)
    :
    Window3(parameters),
...
void IntersectConvexPolyhedraWindow::OnIdle()
{
    mTimer.Measure();
...
bool IntersectConvexPolyhedraWindow::OnCharPress(unsigned char key, int x, int y)
{
    switch (key)
    {
    case '0':
...
void IntersectConvexPolyhedraWindow::CreateScene()
{
...
void IntersectConvexPolyhedraWindow::ComputeIntersection()
{
