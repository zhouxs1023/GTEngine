...
#include "MorphControllersWindow.h"
...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"MorphControllersWindow", 0, 0, 768, 768);
    auto window = TheWindowSystem.Create<MorphControllersWindow>(parameters);
    TheWindowSystem.MessagePump(window, TheWindowSystem.DEFAULT_ACTION);
    TheWindowSystem.Destroy<MorphControllersWindow>(window);
    return 0;
}

MorphControllersWindow::MorphControllersWindow(Parameters& parameters)
    :
    Window3(parameters),
...
void MorphControllersWindow::OnIdle()
{
    mTimer.Measure();
...
bool MorphControllersWindow::OnCharPress(unsigned char key, int x, int y)
{
    switch (key)
    {
    case 'w':
...
bool MorphControllersWindow::SetEnvironment()
{
...
void MorphControllersWindow::CreateScene()
{
