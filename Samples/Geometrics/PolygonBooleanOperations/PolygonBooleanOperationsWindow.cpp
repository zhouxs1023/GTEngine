...
PolygonBooleanOperationsWindow::PolygonBooleanOperationsWindow(Parameters& parameters)
    :
    Window2(parameters),
    mEpsilon(0.00001),
...
void PolygonBooleanOperationsWindow::OnDisplay()
{
...
bool PolygonBooleanOperationsWindow::OnCharPress(unsigned char key, int x, int y)
{
...
std::unique_ptr<BSPPolygon2<double>> PolygonBooleanOperationsWindow::ConstructInvertedEll()
{
...
std::unique_ptr<BSPPolygon2<double>> PolygonBooleanOperationsWindow::ConstructPentagon()
{
...
std::unique_ptr<BSPPolygon2<double>> PolygonBooleanOperationsWindow::ConstructSquare()
{
    double d2d8 = 0.250 * mSize;
    double d6d8 = 0.750 * mSize;
...
std::unique_ptr<BSPPolygon2<double>> PolygonBooleanOperationsWindow::ConstructSShape()
{
...
std::unique_ptr<BSPPolygon2<double>> PolygonBooleanOperationsWindow::ConstructPolyWithHoles()
{
...
void PolygonBooleanOperationsWindow::DrawPolySolid(BSPPolygon2<double>& polygon, unsigned int color)
{
    // Draw the edges.
...
void PolygonBooleanOperationsWindow::DoBoolean()
{
    auto const& P = *mPoly0;
    auto const& Q = *mPoly1;
