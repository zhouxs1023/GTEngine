...
namespace gte
{
    ...
    public:
        ...
        struct Result
        {
            ...
            // set to [maxReal,-maxReal].  If 'intersect' is true,
            // numIntersections is 1 or 2.  When 1, 'overlap' is set to [x,x],
            // which is degenerate and represents the single intersection
            // point x.  When 2, 'overlap' is the interval of intersection.
            ...
            // Smiinfinite interval of intersection, [t0,+infinity).
            static int const isPositiveInfinite = 3;

            // Semiinfinite interval of intersection, (-infinity,t1].
            static int const isNegativeInfinite = 4;

            // The type is one of isEmpty, isPoint, isFinite,
            // isPositiveInfinite or isNegativeInfinite.  TODO: For now, the
            // dynamic find-intersection query does not set 'type'.  Modify
            // these semantics later.
            int type;
