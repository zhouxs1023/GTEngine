...
PointController::PointController(Updater const& postUpdate)
    :
...
void PointController::SetObject(ControlledObject* object)
{
    ...
    if (primitiveType != IP_POLYPOINT)
    {
        LogError("Geometric primitive must be points.");
        return;
    }
